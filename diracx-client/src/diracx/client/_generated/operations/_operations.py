...
def build_pilots_pilot_set_job_statuses_request(  # pylint: disable=name-too-long
    *, force: bool = False, authorization: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_pilots_pilot_add_heartbeat_request(*, authorization: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pilots_pilot_patch_metadata_request(  # pylint: disable=name-too-long
...
class PilotsOperations:
    ...
    @distributed_trace
    def pilot_patch_metadata(  # pylint: disable=inconsistent-return-statements
