...
>>>>>>> 3e79789e (feat: Add pilot auth)
    ...
    # Construct URL
    _url = "/api/pilots/management/secrets"
...
=======
            _json = self._serialize.body(body, "BodyPilotsPilotLogin")

        _request = build_pilots_pilot_login_request(
>>>>>>> 3e79789e (feat: Add pilot auth)
            content_type=content_type,
            json=_json,
            content=_content,
