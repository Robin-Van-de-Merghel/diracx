...
def build_jobs_get_job_jdl_request(job_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/api/jobs/{job_id}/jdl"
    path_format_arguments = {
        "job_id": _SERIALIZER.url("job_id", job_id, "int"),
    }
...
def build_jobs_get_job_heartbeat_info_request(  # pylint: disable=name-too-long
    job_id: int, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/api/jobs/{job_id}/heartbeat"
    path_format_arguments = {
        "job_id": _SERIALIZER.url("job_id", job_id, "int"),
    }
...
class JobsOperations:
    ...
    @distributed_trace
    def get_job_parameters(self, job_id: int, **kwargs: Any) -> List[Dict[str, Any]]:
        """Get Job Parameters.
    ...
    @distributed_trace
    def get_job_heartbeat_info(self, job_id: int, **kwargs: Any) -> List[
        Dict[
            str,
